...
// What to do...
// - What if I used f64 instead of i32?
// - What if I used Vec<u8> instead of numbers?
//
// The thing is... the way the data is formatted and organized
// completely changes the way the functions behave.
// Functions that operate on vectors are structured very
// differently than structures that operate on f64 numbers.
//
// Is there a way to write the functions so that it doesn't matter?
